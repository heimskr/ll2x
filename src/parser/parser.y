...
template <typename T>
const LL2X::ASTLocation & L(std::initializer_list<const T *> nodes) {
...
%initial-action {
    LL2X::llvmParser.root = new LL2X::ASTNode(LL2X::llvmParser, LLVMTOK_ROOT, {0, 0}, "");
}
...
const char * LL2X::Parser::getNameLLVM(int symbol) {
